<template>
  <div class="login-container">
    <div class="login-box">
      <h1 class="login-title">BestPlace Login</h1>
...
export default {
  data(){
    return{
      ...
      googleRedirectUrl: "https://www.bepl.site:3000/member/google/redirect",
      ...
      naverRedirectUrl: "https://www.bepl.site:3000/member/naver/redirect",
...
.login-container {
  ...
  background: #15161b; /* 배경색 변경 */
  padding: 20px;
}

.login-box {
  background: #1e2029; /* 카드 배경색 변경 */
  padding: 40px;
  border-radius: 12px;
...
.google-login {
  background: rgba(255, 255, 255, 0.08); /* 구글 버튼 배경색 변경 */
  color: #ffffff; /* 구글 버튼 텍스트 색상 변경 */
  border: 1px solid rgba(255, 255, 255, 0.1);
}
...
.naver-login {
  background: #03C75A; /* 네이버 원래 색상 유지 */
  color: white;
}
...
.divider {
  ...
  margin: 20px 0;
  height: 1px;
  background: rgba(255, 255, 255, 0.1); /* 구분선 색상 변경 */
}

.form-input {
  width: 100%;
  padding: 12px;
  background: rgba(255, 255, 255, 0.05); /* 인풋 배경 변경 */
  color: #ffffff;
  border: 1px solid rgba(255, 255, 255, 0.1);
  border-radius: 8px;
  font-size: 1rem;
...
.form-input:focus {
  outline: none;
  border-color: #5ca1a8; /* primary 색상으로 변경 */
}

.submit-button {
  width: 100%;
  padding: 12px;
  background: #5ca1a8; /* primary 색상으로 변경 */
  color: white;
  border: none;
  border-radius: 8px;
  font-size: 1rem;
...
.submit-button:hover {
  background: #4a8f96; /* primary 색상 다크 버전 */
}
</style>